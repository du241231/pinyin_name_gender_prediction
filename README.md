...
## Data
We provide the 9,800 Names dataset and the 20,000 Names dataset used in our experiments in the `./data` folder. You can get the 58M Names dataset from [https://github.com/ZhangDataLab/CHGAT/](https://github.com/ZhangDataLab/CHGAT/) 
## Prerequisites
